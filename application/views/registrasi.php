							...
							<form method="post" >
								<div class="ml-3">
									...
									<div class="form-group mb-2">
										<input style="height: 2.5rem" name="nama" placeholder="Nama Asli" class="form-control form-control-sm" type="text" required="true">
									</div>
									<div class="font-weight-lighter mb-1" style="font-size: 0.8rem">
										Email
									</div>
									<div class="form-group">
										<input style="height: 2.5rem" name="email" placeholder="Email" class="form-control form-control-sm" type="text" required="true">
									</div>
									<div class="font-weight-lighter mb-1" style="font-size: 0.8rem">
										Kata Sandi
									</div>
									<div class="form-group">
										<input style="height: 2.5rem" name="password" placeholder="Kata Sandi" class="form-control form-control-sm" type="password" required="true">
									</div>
									<div class="font-weight-lighter mb-1" style="font-size: 0.8rem">
										Konfirmasi Kata Sandi
									</div>
									<div class="form-group">
										<input style="height: 2.5rem" placeholder="Ketik Ulang Kata Sandi" class="form-control form-control-sm" type="password" required="true">
									</div>
								</div>
								<button type="submit" class="btn btn-konco mb-2" style="position: relative; left: 5%; width: 95%;" name="daftar">Daftar</button>
